...
INSERT INtO `ORDERS` VALUES('order-11111-22222-33335', 'user-11111-22222-33333', DATE_SUB(CONCAT(CURDATE(), ' 14:00:00'), INTERVAL 1 DAY), DATE_SUB(CONCAT(CURDATE(), ' 04:00:00'), INTERVAL 1 DAY), 30000, 'addr5', 123123, 'PENDING');
INSERT INtO `ORDERS` VALUES('order-11111-22222-33336', 'user-11111-22222-33333', DATE_SUB(CONCAT(CURDATE(), ' 14:00:00'), INTERVAL 1 DAY), DATE_SUB(CONCAT(CURDATE(), ' 04:00:00'), INTERVAL 1 DAY), 30000, 'addr5', 123123, 'PENDING');
INSERT INtO `ORDERS` VALUES('order-11111-22222-33337', 'user-11111-22222-33333', DATE_SUB(CONCAT(CURDATE(), ' 14:00:00'), INTERVAL 1 DAY), DATE_SUB(CONCAT(CURDATE(), ' 04:00:00'), INTERVAL 1 DAY), 30000, 'addr5', 123123, 'PENDING');
INSERT INtO `ORDERS` VALUES('order-11111-22222-33338', 'user-11111-22222-33333', DATE_SUB(CONCAT(CURDATE(), ' 14:00:00'), INTERVAL 1 DAY), DATE_SUB(CONCAT(CURDATE(), ' 04:00:00'), INTERVAL 1 DAY), 30000, 'addr5', 123123, 'PENDING');
INSERT INtO `ORDERS` VALUES('order-11111-22222-33339', 'user-11111-22222-33333', DATE_SUB(CONCAT(CURDATE(), ' 14:00:00'), INTERVAL 1 DAY), DATE_SUB(CONCAT(CURDATE(), ' 04:00:00'), INTERVAL 1 DAY), 30000, 'addr5', 123123, 'PENDING');
INSERT INtO `ORDERS` VALUES('order-11111-22222-33310', 'user-11111-22222-33333', DATE_SUB(CONCAT(CURDATE(), ' 14:00:00'), INTERVAL 1 DAY), DATE_SUB(CONCAT(CURDATE(), ' 04:00:00'), INTERVAL 1 DAY), 30000, 'addr5', 123123, 'PENDING');
INSERT INtO `ORDERS` VALUES('order-11111-22222-33311', 'user-11111-22222-33333', DATE_SUB(CONCAT(CURDATE(), ' 14:00:00'), INTERVAL 1 DAY), DATE_SUB(CONCAT(CURDATE(), ' 04:00:00'), INTERVAL 1 DAY), 30000, 'addr5', 123123, 'PENDING');
INSERT INtO `ORDERS` VALUES('order-11111-22222-33312', 'user-11111-22222-33333', DATE_SUB(CONCAT(CURDATE(), ' 14:00:00'), INTERVAL 1 DAY), DATE_SUB(CONCAT(CURDATE(), ' 04:00:00'), INTERVAL 1 DAY), 30000, 'addr5', 123123, 'PENDING');
