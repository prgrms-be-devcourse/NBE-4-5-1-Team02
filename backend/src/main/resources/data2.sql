...
INSERT INTO `ORDERS` VALUES('o1', 'u1', CONCAT(DATEADD('DAY', -1, CURDATE()), ' 16:00:00'), CONCAT(DATEADD('DAY', -1, CURDATE()), ' 16:00:00'), 15000, 'Seoul, Gangnam-gu', 101010, 'PENDING');
INSERT INTO `ORDERS` VALUES('o2', 'u1', CONCAT(DATEADD('DAY', -1, CURDATE()), ' 16:00:00'), CONCAT(DATEADD('DAY', -1, CURDATE()), ' 16:00:00'), 22000, 'Seoul, Jongno-gu', 101011, 'PENDING');
INSERT INTO `ORDERS` VALUES('o3', 'u1', CONCAT(DATEADD('DAY', -1, CURDATE()), ' 16:00:00'), CONCAT(DATEADD('DAY', -1, CURDATE()), ' 16:00:00'), 18000, 'Seoul, Mapo-gu', 101012, 'SHIPPED');
INSERT INTO `ORDERS` VALUES('o4', 'u1', CONCAT(DATEADD('DAY', -1, CURDATE()), ' 16:00:00'), CONCAT(DATEADD('DAY', -1, CURDATE()), ' 16:00:00'), 30000, 'Seoul, Yongsan-gu', 101013, 'DELIVERED');
INSERT INTO `ORDERS` VALUES('o5', 'u1', CONCAT(DATEADD('DAY', -1, CURDATE()), ' 16:00:00'), CONCAT(DATEADD('DAY', -1, CURDATE()), ' 16:00:00'), 25000, 'Seoul, Seocho-gu', 101014, 'CANCELLED');
