...
class OrderControllerAdminTest {
    ...
    void getAllOrders() throws Exception {
        ...
        resultActions
                ...
                .andExpect(jsonPath("$.code").value(200))  // code 값 검증
                .andExpect(jsonPath("$.message").value("ok"))  // message 값 검증
                .andExpect(jsonPath("$.data.content.length()").value(5))  // content 배열의 길이 검증
                .andExpect(jsonPath("$.data.page").value(1))  // 페이지 번호 검증
                .andExpect(jsonPath("$.data.size").value(10))  // 한 페이지에 포함된 항목 수 검증
                .andExpect(jsonPath("$.data.totalPages").value(1));  // 전체 페이지 수 검증

        // 각 주문 항목에 대한 검증
        resultActions
                .andExpect(jsonPath("$.data.content[0].orderId").value("order-11111-22222-33335"))
                .andExpect(jsonPath("$.data.content[0].orderDate").value("2025-02-21T16:15:35.3138"))
        ...
        resultActions
                ...
                .andExpect(jsonPath("$.data.content[1].orderDate").value("2025-02-21T16:15:35.30809"))
        ...
        resultActions
                ...
                .andExpect(jsonPath("$.data.content[2].orderDate").value("2025-02-21T16:15:35.306558"))
        ...
        resultActions
                ...
                .andExpect(jsonPath("$.data.content[3].orderDate").value("2025-02-21T16:15:35.305561"))
        ...
        resultActions
                ...
                .andExpect(jsonPath("$.data.content[4].orderDate").value("2025-02-21T16:15:35.304557"))
                ...
                .andExpect(jsonPath("$.data.content[4].items[1].quantity").value(5));  // 두 개의 상품이 있는지 검증
    }
